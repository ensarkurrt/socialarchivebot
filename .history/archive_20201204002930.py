...
if __name__ == "__main__":
    #main()
    datetime = "2020-12-03T14:56:36.000Z"
    arr = {'day': datetime[8,10],'mounth': datetime[5,7],'year': datetime[0,4],'hour': datetime[11,13],'minute':datetime[14,16],'second':datetime[17,19]}
    print(arr[])
    pass
