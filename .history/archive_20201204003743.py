...
def getImage(driver,username):
    ...
    img.save(createFileSystem(driver,username,'foto.png'), "PNG")

    response = requests.get(pic_url)
    open(createFileSystem(driver,username,'foto.png'), "w")
    file = open(createFileSystem(driver,username,'foto.png'), "wb")
