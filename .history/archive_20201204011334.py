...
def stopStory(driver):
    while get_attribute_xpath(driver,'//*[@id="react-root"]/section/div[1]/div/section/div/header/div[2]/div[2]/button[1]/div/svg','aria-label') == 'Durdur':
