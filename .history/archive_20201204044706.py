...
def recordProfile(driver,username):
    ...
    try:
        ...
        logError(username,{'url':driver.current_url,'exception':str(e),'message':'profile info did not download'})
    ...
    try:
        ...
        logError(username,{'url':driver.current_url,'exception':str(e),'message':'profile followin did not download'})
