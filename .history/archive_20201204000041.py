...
def getVideo(driver,username):
    ...
    urllib.request.urlretrieve(url_link, 'stories/'+username+'/'+getStoryTime(dri)+'video_'+username+'.mp4')
...
def getImage(driver,username):
    ...
    with open('stories/'+username+'/'+getStoryTime(driver)+'/foto.jpg', 'wb') as handle:
