...
def stopStory(driver):
    if get_attribute_xpath(driver,'//*[@id="react-root"]/section/div[1]/div/section/div/header/div[2]/div[2]/button[1]/div/svg','aria-label') == 'Durdur':
...
def nextStory(driver):
     try:
        get_by_element_xpath(driver,'//*[@id="react-root"]/section/div[1]/div/section/div/button[2]/div')
    except:
        return False
    return click_to_element_xpath(driver,'//*[@id="react-root"]/section/div[1]/div/section/div/button[2]/div')
