...
def createFileSystem(datetime,username):
    return 'stories/'+username+'/'+datetime['year']+'/'+datetime['mounth']+'/'+datetime['day']+'/video_'+datetime['hour']+'_'+datetime['minute']+'_'+datetime['second']+'.mp4'
