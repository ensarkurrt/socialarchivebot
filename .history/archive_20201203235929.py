...
def getStoryTime(driver):
    get_attribute_xpath(driver,'//*[@id="react-root"]/section/div[1]/div/section/div/header/div[2]/div[1]/div/div/div/time','tit')
...
def getImage(driver,username):
    ...
    with open('stories/'+username+'/foto_.jpg', 'wb') as handle:
