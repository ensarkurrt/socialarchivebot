...
def getVideo(driver,username):
    try:
        ...
        logError(username,{'url':driver.current_url,'exception':e.t,'message':'video did not download'})
...
def getImage(driver,username):
    try:
        ...
        logError(username,{'url':driver.current_url,'exception':e,'message':'image did not download'})
        pr('Bu hikaye indirilemedi.','!!!')
